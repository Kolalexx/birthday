...
$codes = [
    ...
    "9F3D7" => "✅ Моя половиночка! Ты как эта икра - драгоценна, изысканна и даришь мгновения наслаждения! 🍽️✨ Следующий сюрприз ждёт тебя там, где воздух наполнен ароматом весны… Ищи там, где все цветет и пахнет 🌸",
    ...
    "8G5T4" => "🎁 Дорогая, позволь мне пригласить тебя на романтический ужин! 🌹 Где: Союз 28 ⏰ Во сколько: 18-00 💐 Дресс-код: Ты — самая красивая (как всегда!) Пусть этот вечер станет идеальным завершением твоего дня! Я уже зарезервировал столик с видом на море. Готова к новому приключению? 💖",
    "2X5L9" => "✅ ",
];
